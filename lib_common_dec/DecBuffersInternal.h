...
#define MAX_NB_REF_PLANE 3

static const int SCLST_SIZE_DEC = 12288;

#define AL_JPEG_HUFFMAN_BUF_SIZE 512
typedef uint16_t quant_jpeg_t;
#define AL_JPEG_MIN_MAX_BUF_SIZE 320
#define AL_JPEG_NUM_QUANT_COEFF 64
#define AL_JPEG_QUANT_BUF_SIZE (4 * AL_JPEG_NUM_QUANT_COEFF * sizeof(quant_jpeg_t))
