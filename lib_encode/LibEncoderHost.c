...
/****************************************************************************/
static AL_ERR AL_Encoder_CreateWithCtx_Host(AL_HEncoder* hEnc, AL_RiscV_Ctx ctx, AL_TAllocator* pAlloc, AL_TEncSettings const* pSettings, AL_CB_EndEncoding callback)
{
  (void)hEnc;
  (void)ctx;
  (void)pAlloc;
...
/****************************************************************************/
static void AL_Encoder_NotifyIsSkip_Host(AL_HEncoder hEnc)
{
  AL_TEncoder* pEnc = (AL_TEncoder*)hEnc;
  AL_Common_Encoder_NotifyIsSkip(pEnc->pCtx);
}

/****************************************************************************/
static void AL_Encoder_NotifyGMV_Host(AL_HEncoder hEnc, int iNumFrame, int GMV_x, int GMV_y)
{
  AL_TEncoder* pEnc = (AL_TEncoder*)hEnc;
  AL_Common_Encoder_NotifyGMV(pEnc->pCtx, iNumFrame, GMV_x, GMV_y);
}
...
/****************************************************************************/
static bool AL_Encoder_SetAutoQPThresholdAndDelta_Host(AL_HEncoder hEnc, bool bUserAutoQP, AL_TAutoQPCtrl* userAutoQPValues)
{
  AL_TEncoder* pEnc = (AL_TEncoder*)hEnc;
  return AL_Common_Encoder_SetAutoQPThresholdAndDelta(pEnc, bUserAutoQP, userAutoQPValues);
}
...
static AL_IEncArchVtable vtable =
{
  ...
  .EncoderCreateWithCtx = AL_Encoder_CreateWithCtx_Host,
  ...
  .EncoderNotifyIsSkip = AL_Encoder_NotifyIsSkip_Host,
  .EncoderNotifyGMV = AL_Encoder_NotifyGMV_Host,
  ...
  .EncoderSetAutoQPThresholdAndDelta = AL_Encoder_SetAutoQPThresholdAndDelta_Host,
