...
/*****************************************************************************
   \brief The Encoder_NotifyIsSkip function informs the encoder that the
   next picture is a skip picture
   \param[in] pEnc Handle to an encoder object
*****************************************************************************/
...
/*****************************************************************************
   \brief The AL_Common_Encoder_SetAutoQPThresholdAndDelta set the ThresholdQP
